...
class SimplestCasesTest extends BaseTest
{
    ...
    public function testEachAttributeTypeReturnedInProperFormat(): void
    {
        // arrange
        $select = new Select(155);
        $select->addAttributeToReturn(new EntityAttribute(155, '57e77c4c-1987-439e-9460-30c8e5718352', Type::FILE));
        $select->addAttributeToReturn(new EntityAttribute(155, 'a1360fed-0cd0-4203-b5ad-5fb3d3be94e1', Type::ENUM));
        $select->addAttributeToReturn(new EntityAttribute(155, 'b8a758d1-0ee4-4d02-a8a5-b306b5b0e3b8', Type::TEXT));
        $select->addAttributeToReturn(new EntityAttribute(155, 'be02eebb-fd15-4a14-aed6-a92b4f8e5ebc', Type::STRING));
        $select->addAttributeToReturn(new EntityAttribute(155, '02180769-544e-4a8e-84ef-5edbaadf8f69', Type::INTEGER));
        $select->addAttributeToReturn(new EntityAttribute(155, '13176abe-5142-4876-878f-f1cfe7a71ae3', Type::DECIMAL));
        $select->addAttributeToReturn(new EntityAttribute(155, '48ecc249-aa74-40e2-bf25-870a806c5cf1', Type::BOOLEAN));
        $select->addAttributeToReturn(new EntityAttribute(155, '8b95c9ee-0e2a-48b7-a321-b2d72e4a286a', Type::DATETIME));
        $select->addAttributeToReturn(new EntityAttribute(155, 'a9f7ff25-3109-48d4-a185-13389c829f88', Type::DATETIME));
