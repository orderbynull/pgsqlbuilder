...
class SimplestCasesTest extends BaseTest
{
    ...
    public function testDeletedFileIsNotAggregatedIntoFinalResult(): void
    {
        // arrange
        $sut = new Select(155);
        $sut->addAttributeToReturn(new EntityAttribute(155, '88e77c4c-1987-439e-9460-30c8e5718352', Type::FILE));
        ...
        [
            {
                "row_id":1, 
                "ent_155_attr_88e77c4c_1987_439e_9460_30c8e5718352_1": []
            }
        ]
        RAW;
    ...
    protected function up(): string
    {
        return <<<RAW
            ...
            -- Удаленный файл
            INSERT INTO public.files (id, fileable_type, fileable_id, name, path, mimetype, size, hash, created_at, updated_at, entity_attribute_id, deleted_at) VALUES (666, 'user', 35, 'deleted.png', 'original/36_35_abc.png', 'image/png', 999, '"7be9941dc7e545e468062275f65d7b5f"', '2020-06-29 07:31:40', '2020-06-29 07:31:40', null, '2020-06-29 07:31:40');
